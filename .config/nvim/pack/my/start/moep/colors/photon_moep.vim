...
let colors_name = "photon_moep"

if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    hi Normal ctermbg=235 ctermfg=251 cterm=NONE guibg=#222222 guifg=#c6c6c6 gui=NONE
    ...
    hi CursorLine ctermbg=238 ctermfg=NONE cterm=NONE guibg=#303030 guifg=NONE gui=NONE
